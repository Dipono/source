...
async function main() {
    ...
    // map.on("click", async function (e) {
        ...
        var coordinate = [{long:25.08504994, lat:-28.997182288}, {long:24.08504994, lat:-27.997182288}, {long:28.2292712, lat:-25.7478676}]
        // Render a marker on clicked point
        for(var k = 0; k < coordinate.length; k++){
            marker = new maplibregl.Marker().setLngLat([coordinate[k].long, coordinate[k].lat]).addTo(map);
        }
